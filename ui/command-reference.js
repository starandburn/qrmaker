    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { terms: ["move_cursor(\"up\")", "move_cursor(\"down\")"], description: "上下へ1セル移動します。" },
          { terms: ["move_cursor(\"left\")", "move_cursor(\"right\")"], description: "左右へ1セル移動します。" },
          { terms: ["up()", "down()", "left()", "right()"], description: "方向移動の短縮形です。" },
          { terms: ["move_cursor(\"A1\")", "move_cursor(10, 5)"], description: "A1形式、または行・列の数字で指定位置へ移動します。" },
          { terms: ["move_cursor(\"home\")", "move_cursor(\"end\")"], description: "左上、または右下へ移動します。" },
        ],
      },
      {
        heading: "配置",
